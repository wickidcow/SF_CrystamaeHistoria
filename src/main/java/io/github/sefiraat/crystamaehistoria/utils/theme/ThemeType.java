...
public enum ThemeType {
     ...
     * @param themeType The {@link ThemeType} legacy color string to apply to the {@link SlimefunItemStack} name
     ...
     * @param themeType The {@link ThemeType} legacy color string to apply to the {@link ItemStack} name
